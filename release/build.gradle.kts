...
$previewSiteUri/avatica/docs/history.html

The commit to be voted upon:
https://gitbox.apache.org/repos/asf?p=calcite-avatica.git;a=commit;h=$gitSha
...
RAT report:
$previewSiteUri/avatica/rat/rat-report.txt

Site preview is here:
$previewSiteUri/avatica/

JavaDoc API preview is here:
$previewSiteUri/avatica/api
...
val baseFolder = "apache-calcite-avatica-${rootProject.version}"
...
for (archive in listOf(Zip::class, Tar::class)) {
    ...
    val archiveTask = tasks.register(taskName, archive) {
        ...
        archiveBaseName.set("apache-calcite-avatica")
